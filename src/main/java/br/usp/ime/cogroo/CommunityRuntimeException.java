...
public class CommunityRuntimeException extends InternationalizedRuntimeException {


  /**
   * The name of the {@link java.util.ResourceBundle ResourceBundle} containing the standard Cogroo
   * Exception messages.
   */
   ...
   *          arguments.
   */
  public CommunityRuntimeException(String aResourceBundleName, String aMessageKey, Object[] aArguments) {
   ...
   *          the original exception that caused this exception to be thrown, if any
   */
  public CommunityRuntimeException(String aMessageKey, Object[] aArguments, Throwable aCause) {
