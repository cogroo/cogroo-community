...
public class AnalyticsManagerImpl implements AnalyticsManager {
	...
	public AnalyticsManagerImpl(String appName, String username, String password) {
	...
	/* (non-Javadoc)
	 * @see br.usp.ime.cogroo.logic.AnalyticsManager#setUpDataRequest(java.lang.String, java.util.List, java.util.List, java.util.Date, java.util.Date)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see br.usp.ime.cogroo.logic.AnalyticsManager#authenticate(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see br.usp.ime.cogroo.logic.AnalyticsManager#getData(java.lang.String, java.util.List, java.util.List, java.util.Date, java.util.Date)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see br.usp.ime.cogroo.logic.AnalyticsManager#getDatedMetricsAsString(br.usp.ime.cogroo.model.DataFeed)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see br.usp.ime.cogroo.logic.AnalyticsManager#googleAnalyticsGetImageUrl(javax.servlet.http.HttpServletRequest)
	 */
	@Override
