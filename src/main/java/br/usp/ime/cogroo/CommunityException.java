...
public class CommunityException extends InternationalizedException {
   ...
   *          arguments.
   */
  public CommunityException(String aResourceBundleName, String aMessageKey, Object[] aArguments) {
   ...
   *          the original exception that caused this exception to be thrown, if any
   */
  public CommunityException(String aMessageKey, Object[] aArguments, Throwable aCause) {
