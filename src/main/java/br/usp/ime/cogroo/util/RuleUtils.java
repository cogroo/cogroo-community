...
public class RuleUtils {
	...
	public static Map<RuleInfo, String> getRuleAsString(Rule rule) {
		...
		map.put(RuleInfo.PATTERN, getPatternAsHTML(rule));
		map.put(RuleInfo.BOUNDARIES, getBoundariesAsString(rule));
		map.put(RuleInfo.SUGGESTIONS, getSuggestionsAsHTML(rule));
		return map;
	}
...
//			sb.append(openSpan(OP, "não") + "&ne;" + CLOSESPAN);
	...
	public static String getSuggestionsAsHTML(Rule rule) {
		StringBuilder sb = new StringBuilder();
