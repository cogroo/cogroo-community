...
<br/>
<p>Parabéns, você alterou sua senha, se precisar já poderá efetuar o login com a nova senha.</p>
<br/>
<br/>
<div class="specialframe">
    ...
    <ul>
    	...
    	<li>4-Tudo pronto, você já poderá entra no CoGrOO Comunidade com a sua nova senha.<b><-- Estamos aqui!</b></li>
    </ul>
</div>
